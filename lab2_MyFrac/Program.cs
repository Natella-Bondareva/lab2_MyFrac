...
namespace lab2_MyFrac
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Дріб, до якого додали щойновведений дріб:" + myFrac.Plus(myFrac,myFracPlus).ToString());
            ...
            //Console.WriteLine("Дріб від якого відняли щойновведений дріб:" + myFrac.Minus(myFrac, myFracMinus).ToString());
            ...
            //Console.WriteLine("Дріб, до якого домножили щойновведений дріб:" + myFrac.Multiply(myFrac, myFracMultiply).ToString());
            ...
            //Console.WriteLine("Дріб, який поділили на щойновведений дріб:" + myFrac.Divide(myFrac, myFracDivide).ToString());
